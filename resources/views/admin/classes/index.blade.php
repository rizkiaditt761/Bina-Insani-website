        ...
        <div class="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm leading-6 text-blue-100">
                    ...
                    Kelola seluruh program pelatihan yang ditampilkan
        ...
        <div
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-500">
                    Gunakan pencarian atau filter status untuk menemukan program.
                </p>
                    ...
                    @forelse($classes as $class)
                        ...
                        <tr
                            ...
                            <td class="px-5 py-4 text-center align-middle">
                                ...
                                <span class="whitespace-nowrap text-sm font-semibold text-blue-700">
                            ...
                            <td
                                ...
                                <div class="mx-auto flex max-w-sm flex-col items-center">
                                    ...
                                    <p class="mt-2 text-sm leading-6 text-slate-500">
                                        ...
                                        Tidak ada program yang sesuai dengan
